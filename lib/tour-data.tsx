  ...
  },
  {
    ...
    content: (
      <>
        ...
        <a href="https://github.com/Cloudn9-k" target="_blank" rel="noopener noreferrer">
          <Button variant="outline" className="w-full">
            <Github className="mr-2 h-4 w-4" />
            View on GitHub
          </Button>
        </a>
        <p className="text-xs text-foreground/50 text-center mt-3">Copyright © Tong An Khang</p>
      </>
    ),
  }
];